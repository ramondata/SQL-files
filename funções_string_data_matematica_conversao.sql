...
SELECT cpf
	  ...
	  ,sexo
	  ,idade
	  ,concat(BAIRRO,' - ', CEP) as endereço
FROM [TABELA DE CLIENTES]


SELECT CONCAT(NOME, ' (', CPF, ') ') FROM [TABELA DE CLIENTES]
select len(substring('ramon_barbosa', 1,5))
...
SELECT RAND()
SELECT ROUND(12.33323323, 5)
SELECT * FROM [ITENS NOTAS FISCAIS]
SELECT [QUANTIDADE], [PREÇO], ROUND(([QUANTIDADE] * [PREÇO]),1), ([QUANTIDADE] * [PREÇO]) FROM [ITENS NOTAS FISCAIS]
